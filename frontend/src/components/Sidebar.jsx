...
function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-y-2 h-[410px] lg:h-[410px] 
      ...
      <div className="flex flex-col gap-y-3 py-4 mt-4">
        <div className="flex w-full justify-between items-center">
          ...
          <div className='uppercase font-semibold'>
            ...
            {parseFloat(total).toFixed(2)} VND
          </div>
          {/*clear cart*/}
        ...
        <Link to='/' className="bg-blue-400 flex p-4 justify-center items-center text-white w-full font-medium">Checkout</Link>
      </div>
    </div>
  );
}
